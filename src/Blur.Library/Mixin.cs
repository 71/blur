...
namespace Blur
{
    ...
    /// during compilation.
    /// </summary>
    public sealed class MixinVisitor : BlurVisitor
    {
        private readonly TypeReference MixinType = typeof(MixinAttribute).GetReference();

        public MixinVisitor() : base(ProcessingState.After)
        {
        }
